# This taken from Real_Time_Image_Animation/image_animation.py
import imageio
import torch
...
#out2 = cv2.VideoWriter('output/test_dst.avi', fourcc, 12, (256 , 256), True)
